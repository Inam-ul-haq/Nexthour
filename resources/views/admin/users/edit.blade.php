           ...
           <div class="search form-group{{ $errors->has('password') ? ' has-error' : '' }}">
            ...
            <div class="form-group{{ $errors->has('is_admin') ? ' has-error' : '' }}">
              <div class="row">
                ...
                <div class="col-xs-5 pad-0">
                  <label class="switch">								
                    {!! Form::checkbox('is_admin', 1, $user->is_admin, ['class' => 'checkbox-switch', 'id' => 'is_admin_cb']) !!}
            ...
            <div class="form-group{{ $errors->has('is_assistant') ? ' has-error' : '' }} switch-main-block">
              <div class="row">
                ...
                <div class="col-xs-5 pad-0">
                  <label class="switch">                
                    {!! Form::checkbox('is_assistant', 1, $user->is_assistant, ['class' => 'checkbox-switch','id' => 'is_producer_cb']) !!}
                    <span class="slider round"></span>
                  </label>
                </div>
              </div>
