...
<body>
	...
	<div style="padding:50px;background: url({{ url('images/email-bg.jpg') }});background-color:#111;background-size: cover;width: 100%;height: 100%;" class="box">
		<div align="center" class="logo">
			...
			<div align="center">
				<a style="cursor: pointer;" href="{{route('sendEmailDone',["email" => $user->email, "verifyToken" => $user->verifyToken])}}"><button style="cursor: pointer;" class="wel">Verify Now !</button></a>
			</div>
