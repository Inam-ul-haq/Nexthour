...
@section('title','All Audio Languages')
@section('content')
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="{{route('audio_language.create')}}" class="btn btn-danger btn-md"><i class="material-icons left">add</i> Create Language</a>
      <!-- Delete Modal -->
    ...
    $(function () {
      ...
      var table = $('#audio_languageTable').DataTable({
         ...
         scrollCollapse: true,
          ...
          ajax: "{{ route('audio_language.index') }}",
          columns: [
