                      ...
                      <div id="prime-mix-description-block{{$item->id}}{{$item->type}}" class="prime-description-block">
                        ...
                        <div class="des-btn-block">
                          @if (isset($gets1->episodes[0]))
                            ...
                            <a href="#" onclick="playoniframe('{{ $gets1->episodes[0]->video_link['iframeurl'] }}','{{ $gets1->episodes[0]->seasons->tvseries->id }}','tv')" class="btn btn-play"><span class= "play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{$popover_translations->where('key', 'play')->first->value['value']}}</span>
                             </a>
                    ...
                    <div class="genre-prime-slide">
                      ...
                      <div id="prime-next-movie-description-block{{$movie->id}}" class="prime-description-block">
                        <div class="prime-description-under-block">
                          ...
                          <div class="main-des">
                            <p>{{$movie->detail}}</p>
                             @if($auth && $subscribed==1)
                                <a href="{{url('movie/detail',$movie->id)}}">Read more</a>
                             @else
                                <a href="{{url('movie/detail',$movie->id)}}">Read more</a>
                             @endif
                          </div>
                      ...
                      @if($subscribed==1 && $auth)
                          @if($movie->trailer_url != null || $movie->trailer_url != '')
                             <a class="iframe btn btn-default" href="{{ route('watchTrailer',$movie->id) }}">{{$popover_translations->where('key', 'watch trailer')->first->value['value']}}</a>
                          @endif
                          @else
                           @if($movie->trailer_url != null || $movie->trailer_url != '')
                             <a class="iframe btn btn-default" href="{{ route('guestwatchtrailer',$movie->id) }}">{{$popover_translations->where('key', 'watch trailer')->first->value['value']}}</a>
                          @endif
                          @endif
                      ...
                      @endphp
                        ...
                        @endif
                          ...
                          <div id="prime-next-show-description-block{{$series->id}}{{$series->type}}" class="prime-description-block">
                            ...
                            <div class="des-btn-block">
                              @if (isset($gets1->episodes[0]))
                                @if($series->age_req == 'all age' || $age>=str_replace('+', '', $series->age_req))
                              @if($gets1->episodes[0]->video_link['iframeurl'] !="")
                        ...
                        <div id="prime-genre-tvseries-description-block{{$item->id}}{{$item->type}}" class="prime-description-block">
                          ...
                          <div class="des-btn-block">
                            @if (isset($gets1->episodes[0]))
                              ...
                              <a href="#" onclick="playoniframe('{{ $gets1->episodes[0]->video_link['iframeurl'] }}','{{ $item->id }}','tv')" data-movieid="{{ $gets1->episodes[0]->id }}"  class="btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{$popover_translations->where('key', 'play')->first->value['value']}}</span>
                              </a>
                              @else
                              <a href="{{ route('watchTvShow',$gets1->id) }}" class="iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{$popover_translations->where('key', 'play')->first->value['value']}}</span></a>
                              @endif
                        ...
                        <div id="prime-genre-tvseries-description-block{{$item->id}}{{$item->type}}" class="prime-description-block">
                          ...
                          <div class="des-btn-block">
                            @if (isset($gets1->episodes[0]))
                              ...
                              <a href="#" onclick="playoniframe('{{ $gets1->episodes[0]->video_link['iframeurl'] }}','{{ $item->id }}','tv')" class="btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{$popover_translations->where('key', 'play')->first->value['value']}}</span>
                              </a>
                              @else
                              <a href="{{ route('watchTvShow',$gets1->id) }}" class="iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{$popover_translations->where('key', 'play')->first->value['value']}}</span></a>
                              @endif
                      ...
                      @if($item->tvseries['status'] == 1)
                          <div class="genre-slide">
                            <div class="genre-slide-image">
                               @if($auth && $subscribed==1)
                                <a @if(isset($item)) href="{{url('show/detail',$item->id)}}" @endif>
                                  @if($item->thumbnail != null)
                                    <img src="{{asset('images/tvseries/thumbnails/'.$item->thumbnail)}}" class="img-responsive" alt="genre-image">
                                  @elseif($item->tvseries['thumbnail'] != null)
                                    <img src="{{asset('images/tvseries/thumbnails/'.$item->thumbnail)}}" class="img-responsive" alt="genre-image">
                               ...
                               @else
                                 <a @if(isset($item)) href="{{url('show/guest/detail',$item->id)}}" @endif>
                                  @if($item->thumbnail != null)
                                    <img src="{{asset('images/tvseries/thumbnails/'.$item->thumbnail)}}" class="img-responsive" alt="genre-image">
                                  @elseif($item->tvseries['thumbnail'] != null)
                                    <img src="{{asset('images/tvseries/thumbnails/'.$item->tvseries->thumbnail)}}" class="img-responsive" alt="genre-image">
        ...
        <div class="genre-main-block">
          ...
          @if($t9->status==1)<div class="container-fluid">
            <div class="row">
              <div class="col-md-3">
                <div class="genre-dtl-block">
                  <h3 class="section-heading">{{$home_translations->where('key', 'item and movies')->first->value['value']}}</h3>
                  <p class="section-dtl">{{$home_translations->where('key', 'at the big screen at home')->first->value['value']}}</p>
                  @if($auth && $subscribed==1)
                    <a href="{{ route('showall',['menuid' => $menu->id, 'menuname' => $menu->name]) }}" class="see-more"> <b>{{$home_translations->where('key', 'view all')->first->value['value']}}</b></a>
                    @else
         ...
         <div class="genre-main-block">
          ...
          @if($t11->status==1)<div class="container-fluid">
            <div class="row">
              <div class="col-md-3">
                <div class="genre-dtl-block">
                  <h3 class="section-heading">{{$home_translations->where('key', 'item')->first->value['value']}}</h3>
                  <p class="section-dtl">{{$home_translations->where('key', 'at the big screen at home')->first->value['value']}}</p>
                     @if($auth && $subscribed==1)
                  <a href="{{ route('showall3') }}" class="see-more"> <b>{{$home_translations->where('key', 'view all')->first->value['value']}}</b></a>
                  @else
